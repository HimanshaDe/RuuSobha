            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
                            <img src="assets/images/haircurly.jpg" alt="product" class="img-responsive ">
                        </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image2 ">
                            <img src="assets/images/tools.jpg" alt="product" class="img-responsive ">
                          </div>
                    </div>
                </div>
        </div>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-6 back-image">
                    <img src="assets/images/female-hairstylist-drying-curly-girl-s-hair-using-big-plastic-brush.jpg" alt="product" class="img-responsive ">
                </div>
                <div class="col-lg-6 about-right-faq align-self">
                    ...
                    <div  class="image-right">
                        <ul class="w3l-right-book">
                            ...
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html"></a></li>
                        </ul>
                </div>
            </div>
        </div>
